...
$data = null;
try {
    $bd = new DataAccess( new PDO('mysql:host=mysql-suricate.alwaysdata.net;dbname=suricate_annonces_db', 'suricate_annonce', 'miaouprime') );
...
if ('/annonces/' == $uri || '/annonces/index.php' == $uri || '/annonces/index.php/logout' == $uri) {
    ...
    // traitement de l'insertion d'une annonce si nécessaire
    if (isset($_POST['contractType']))
        $controller->annoncesCreationAction($_SESSION['login'],$_POST,$dataAnnonces,$annonceCreation);
    ...
    // Affichage formulaire de création d'annonce
